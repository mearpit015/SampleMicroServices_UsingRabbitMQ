...
namespace SampleWebApiAspNetCore.v1.Controllers
{
    ...
    public class FoodsController : ControllerBase
    {
        ...
        //[HttpGet(Name = nameof(GetFoods))]
        //public ActionResult GetFoods(ApiVersion version, [FromQuery] QueryParameters queryParameters)
        //{
        ...
        //    return Ok(new
        //    {
        //        value = JsonSerializer.Serialize(foodItems),
        //        //   links = links
        //    });
        //}
        ...
        public ActionResult GetAllFoods(ApiVersion version, [FromQuery] QueryParameters queryParameters)
        {
            ...
            return Ok(new
            {
                value = JsonSerializer.Serialize(foodItems)//toReturn,
             //   links = links
            });
        }
        ...
        private IEnumerable<LinkDto> GetLinks(int id, ApiVersion version)
        {
            ...
            //var getFoodsLink = _urlHelper.Link(nameof(GetFoods), new { version = version.ToString() });

            //links.Add(
            //  new LinkDto(getFoodsLink, "self", "GET"));
